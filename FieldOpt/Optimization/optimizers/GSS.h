...
class GSS : public Optimizer {
 public:
   ...
   *
   * The algorithm has three termination conditions: max #
   * of objective function evaluations and min step length,
   * and sufficient improvement in the objective.
 ...
 protected:
  ...
  /*!
   * @brief Check if the algorithm has achieved sufficient
   * improvement for a given tolerance.
   * @return true if sufficient improvement has been achieved,
   * false otherwise.
   */
