...
/*!
* @brief This class extends the reservoir boundary constraint
 * with the WellSpline well definition. The purpose is to
 * allow the toe of the well to vary with a fixed heel.
*/
