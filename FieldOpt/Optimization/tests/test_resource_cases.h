...
class TestResourceCases :
 ...
 private:
  ...
  const QMap<QUuid, bool> binary_variables_4d_{
  ...
  const QMap<QUuid, int> integer_variables_3d_{
    {QUuid::createUuid(), 1},
    {QUuid::createUuid(), 2},
    {QUuid::createUuid(), 5}
  };

  const QMap<QUuid, double> real_variables_3d_{
    {QUuid::createUuid(), 1.0},
    {QUuid::createUuid(), 4.0},
    {QUuid::createUuid(), 2.5}
  };

  const QMap<QUuid, double> real_variables_2d_{
    {QUuid::createUuid(), 2.0},
    {QUuid::createUuid(), 3.0}
  };

  QMap<QUuid, double> real_variables_sph_rand_30d_;

  QMap<QUuid, double> real_variables_sph_rand_6d_;
