...
namespace MPI {
/*!
 * @brief The Worker class is responsible for receiving and
 * sending from/to an overseer object. The runner taken as
 * a parameter in the constructor is primarily used for the common MPI helpers.
 */
class Worker {
 public:
