...
/*!
 * This class generates the COMPSEGS keyword.
 * It must be called once pr. well.
 *
 ...
 *  4. Branch number.
 *  5. Distance down tubing from well's zero tubing length
 *  reference to _start_ of connection in this block.
 *  6. Distance down tubing from well's zero tubing length
 *  reference to _end_ of connection in this block.
