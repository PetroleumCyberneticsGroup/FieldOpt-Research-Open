...
void Simulator::updateResultsInModel() {
    ...
    model_->SetResult("CumulativeGasProduction", results_->GetValueVector(Results::Results::Property::CumulativeGasProduction));
    model_->SetResult("CumulativeOilProduction", results_->GetValueVector(Results::Results::Property::CumulativeOilProduction));
    model_->SetResult("CumulativeWaterProduction", results_->GetValueVector(Results::Results::Property::CumulativeWaterProduction));
}
