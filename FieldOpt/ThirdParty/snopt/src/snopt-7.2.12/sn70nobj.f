...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     lenrw, lvlChk, nF, n, neG, Elem(nF), Set(n),
...
!        ------------------------------------------------------------
         if (Set(j) .gt. 0) then
            ...
            Status = 0          ! no need to check the call-status
...
*     ==================================================================
     ...
     &     modefg, nFeas, nG, nJ, nKnown, RightJ, RightG,
...
*     ------------------------------------------------------------------
      ...
      j1        = iw(110) ! start col for obj.    derivative checking
      j2        = iw(111) ! stop  col for obj.    derivative checking
      j3        = iw(112) ! start col for constr. derivative checking
      j4        = iw(113) ! stop  col for constr. derivative checking
...
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     lencu, leniu, lenru, iAfun(lenA), jAvar(lenA),
...
*     ==================================================================
     ...
     &     idamax, dnormi
      integer
     &     i, idamax, j, k, k0, neA0, needF, needG, nFixed, Status,
     &     seeds(3)
      double precision
