...
!     ==================================================================
     ...
     &     FPonly, gotR, PrtMem
      integer
     &     Errors, Hcalls, Htype, inform, lenR, lenx0, lgObj, lgSav,
     &     lhEtyp, lkx, llocG, liwEst, lrwEst, lvlHes, lvlSrt, lx0,
     &     maxcw, maxiw, maxR, maxrw, maxS, minmax, mProb, mQNmod, nb,
     &     negCon, ngObj, ngObj0, ngQP, nextcw, nextiw, nextrw, nkx,
     &     nlocG, nlocJ, nMajor, nnH, nnH0, nrhs, nrhs0, nx0, stkyOp
      double precision
