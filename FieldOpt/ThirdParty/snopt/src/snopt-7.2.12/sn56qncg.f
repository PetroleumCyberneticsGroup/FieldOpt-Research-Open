...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     Hprod, Hprod1, QPlog
      integer
     &     Hcalls, iExit, itQP, itQPmax, itQPtargt, itn, iObj, lencu,
     &     leniu, lenru, lencw, leniw, lenrw, lenR, lenx0, lEmode,
     &     lvlInf, PrtLvl, m, maxS, mBS, minimz, n, nb, ne, nDegen,
     &     ngQP0, ngQP, ngObj0, ngObj, nInf, nlocA, nnH0, nnH, nS,
     &     nrhs0, nrhs, nx0, Prob, subopt, typeLU, locA(nlocA),
     &     indA(ne), hEtype(nb), hEstat(nb), hs(nb), kBS(mBS),
...
!     ==================================================================
     ...
     &     nUncon, PreCon, PrintP, PrintS, QPmode, sqStat,
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     lenrw, locA(nlocA), indA(ne), hEtype(nb), hEstat(nb),
...
!     ==================================================================
     ...
     &     chkpi, hitlow, Exactp, move, onbnd, parHes, Unbndd, Uncon
      integer
     &     inform, infpiv, jEsq, jqStat,
     &     jr, jrStat, js, kBSq, kObj, kSq, m1, modR1, modLU,
     &     mtry, nBS, ntry, nZ1, nZ2, sqStat
      double precision
...
!     ==================================================================
      integer
     &     Hcalls, lenR, lkBS, lR, ly, ly3, mBS, m, maxR, maxS,
     &     n, nb, nnH
!     ------------------------------------------------------------------
...
!     ==================================================================
      integer
     &     inform, m, m1, minimz, nBS, PreCon, sqStat
      double precision
     &     eps0, sgnObj
!     ------------------------------------------------------------------
