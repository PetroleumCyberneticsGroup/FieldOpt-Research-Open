...
declare -a CASES=(
    ...
    "fo_driver.control.rate.npv.trdfo"  	 # 13 [TR-DFO]
    'fo_driver_2_horz_icd_apps_drilling_triggers' # 14 [apps-ICD]
)
...
FODIRTLS="${HOME}/projects/PCG/FieldOpt-Research"
...
DECK_PATH=${CURRENT_DIR}/ECL_5SPOT_C05_OPT.DATA
GRID_PATH=${CURRENT_DIR}/ECL_5SPOT_C05_OPT.EGRID
...
"${DRIVER_PATH} ${OUTPUT_DIR} -r drillingworkflow -n1 -m3 "\
...
CMDSER="${FIELDOPT_BIN} "\
"${DRIVER_PATH} ${OUTPUT_DIR} -r drillingworkflow "\
